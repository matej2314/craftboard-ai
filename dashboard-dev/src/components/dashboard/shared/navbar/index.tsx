          ...
          <div className="flex items-center text-sm font-normal text-navy-700 dark:text-white">
            {breadcrumbs.map((breadcrumb, index) => (
              <Fragment key={`${breadcrumb.path}-${index}`}>
                {index > 0 && (
                  <span className="mx-1 text-navy-700 dark:text-white">/</span>
                )}
                {breadcrumb.isActive ? (
                  ...
                  <NavLink
                    ...
                    className="capitalize text-navy-700 hover:underline dark:text-white dark:hover:text-white"
                  >
                    {breadcrumb.name}
                  </NavLink>
                )}
          ...
          <div className="flex h-48 w-56 flex-col justify-start rounded-[20px] bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none">
            <div className="ml-4 mt-3">
              <div className="flex items-center gap-2">
                <p className="text-sm font-bold text-navy-700 dark:text-white">
                  👋 Hey, {breadcrumbs[breadcrumbs.length - 1].name}
                </p>
              </div>
            </div>
